...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Template permissions (for customers)
        Permission::findOrCreate('view own template');
        Permission::findOrCreate('update own template');
        Permission::findOrCreate('manage template sections');
        Permission::findOrCreate('manage template navigation');
        Permission::findOrCreate('manage template theme');
        Permission::findOrCreate('manage template media');
        ...
        // Customer role gets limited template permissions
