...
class TemplateSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            ...
            ['slug' => 'nova',     'category' => 'kapsalons',         'name' => 'Nova',     'description' => 'Frisse en moderne template voor kapsalons.',               'scheme' => 'trendy',  'font' => 'Inter',         'heading_font' => 'Outfit, sans-serif',        'hero_title' => 'Jouw nieuwe look',        'hero_subtitle' => 'Vakmanschap met een moderne twist'],
            ['slug' => 'pure',     'category' => 'kapsalons',         'name' => 'Pure',     'description' => 'Natuurlijk en organisch design met botanische elementen voor kapsalons.',          'scheme' => 'natural', 'font' => 'Roboto',        'heading_font' => 'Lustria, serif',            'hero_title' => 'Puur vakmanschap',                   'hero_subtitle' => 'Eenvoud en elegantie in elk detail'],
            ...
            ['slug' => 'level',    'category' => 'kapsalons',         'name' => 'Level',    'description' => 'Dynamisch editorial design voor trendy kapsalons met oranje accent.', 'scheme' => 'orange',  'font' => 'Jost',          'heading_font' => 'Syne, sans-serif',          'hero_title' => 'Jouw Haar.<br>Jouw Verhaal.',        'hero_subtitle' => 'Creatief knippen met oog voor detail'],
            ...
            ['slug' => 'spa',      'category' => 'schoonheidssalons', 'name' => 'Spa',      'description' => 'Sereen spa & wellness design met elegante typografie.',        'scheme' => 'beauty',  'font' => 'Lato',          'heading_font' => 'Lustria, serif',            'hero_title' => 'Revitalize Your Beauty,<br>Revitalize Your Soul', 'hero_subtitle' => 'Ontdek pure ontspanning en persoonlijke schoonheidsbehandelingen'],
        ];
    }
