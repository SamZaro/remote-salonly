...
class TemplateSeeder extends Seeder
{
    ...
    private function seedSections(Template $template, array $def, array $defaults): void
    {
        ...
        $sections = [
            ...
            ['section_type' => 'services',     'order' => 3, 'content' => $defaults['services']],
            ['section_type' => 'testimonials', 'order' => 4, 'content' => $defaults['testimonials']],
            ['section_type' => 'contact',      'order' => 5, 'content' => $defaults['contact']],
        ];
