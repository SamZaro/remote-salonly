...
class TemplateSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            // Kapsalons
            ['slug' => 'coupe',    'category' => 'kapsalons',         'name' => 'Coupe',    'description' => 'Moderne en stijlvolle template voor kapsalons.',          'scheme' => 'modern',  'font' => 'Poppins',       'heading_font' => 'Playfair Display, serif',   'hero_title' => 'Welkom bij onze salon',              'hero_subtitle' => 'Waar stijl en vakmanschap samenkomen'],
    ...
    {
        return [
            'luxury'  => ['primary_color' => '#C8B88A', 'secondary_color' => '#0F0F0F', 'accent_color' => '#D4C4A0', 'background_color' => '#F5F3EF', 'text_color' => '#6B6B6B', 'heading_color' => '#0F0F0F', 'navbar_background' => '#0F0F0F', 'navbar_text_color' => '#C8B88A', 'navbar_underline_color' => '#C8B88A'],
            'vintage' => ['primary_color' => '#c9a227', 'secondary_color' => '#1a1a1a', 'accent_color' => '#d4af37', 'background_color' => '#ffffff', 'text_color' => '#555555', 'heading_color' => '#1a1a1a', 'navbar_background' => '#1a1a1a', 'navbar_text_color' => '#c9a227', 'navbar_underline_color' => '#c9a227'],
    ...
    private function seedSections(Template $template, array $def, array $defaults): void
    {
        ...
        $sections = [
            ...
            ['section_type' => 'about',        'order' => 2, 'content' => $defaults['about']],
            ['section_type' => 'features',     'order' => 3, 'content' => $defaults['features']],
            ['section_type' => 'services',     'order' => 4, 'content' => $defaults['services']],
            ['section_type' => 'gallery',      'order' => 5, 'content' => $defaults['gallery']],
            ['section_type' => 'pricing',      'order' => 6, 'content' => $defaults['pricing']],
            ['section_type' => 'parallax',      'order' => 7, 'content' => $defaults['parallax']],
            ['section_type' => 'accordion',    'order' => 8, 'content' => $defaults['accordion']],
            ['section_type' => 'testimonials', 'order' => 9, 'content' => $defaults['testimonials']],
            ['section_type' => 'contact',      'order' => 10, 'content' => $defaults['contact']],
        ];
