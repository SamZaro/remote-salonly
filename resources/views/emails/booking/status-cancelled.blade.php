<x-layouts.email>
    <x-slot name="preview">
        {{ __('Your booking on :date at :time has been cancelled', ['date' => $booking->booking_date->format('d-m-Y'), 'time' => $booking->booking_time]) }}
    </x-slot>
    ...
    <tr>
        <td class="sm-px-6" style="border-radius: 4px; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)" bgcolor="#ffffff">
            ...
            <p style="margin: 0 0 24px; line-height: 24px">
                {{ __('Unfortunately, we have to inform you that your booking at :app_name has been cancelled.', ['app_name' => config('app.name')]) }}
            </p>
            ...
            <p style="margin: 0 0 24px; line-height: 24px">
                {{ __('Would you like to make a new appointment or do you have any questions? Please feel free to contact us.') }}
            </p>
