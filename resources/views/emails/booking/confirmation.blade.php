<x-layouts.email>
    <x-slot name="preview">
        {{ __('Confirmation of your booking on :date at :time', ['date' => $booking->booking_date->format('d-m-Y'), 'time' => $booking->booking_time]) }}
    </x-slot>

    <tr>
        <td class="sm-px-6" style="border-radius: 4px; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)" bgcolor="#ffffff">
            <h1 class="sm-leading-8" style="margin: 0 0 24px; font-size: 24px; font-weight: 600; color: #000">
                {{ __('Your booking has been received!') }}
            </h1>
            ...
            <p style="margin: 0 0 24px; line-height: 24px">
                {{ __('Thank you for your booking at :app_name. Below you will find the details of your appointment.', ['app_name' => config('app.name')]) }}
            </p>
            ...
            <p style="margin: 0 0 16px; line-height: 24px">
                {{ __('Your booking will be confirmed as soon as possible. You will receive a confirmation email.') }}
            </p>

            <p style="margin: 0 0 24px; line-height: 24px">
                {{ __('Do you have any questions or would you like to change your booking? Please contact us.') }}
            </p>
