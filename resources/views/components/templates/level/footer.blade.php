{{--
    Level Template: Footer Section
    Dark warm background — Syne brand name, orange accents, 3-column grid
...
<footer id="footer" class="py-20" style="background-color: {{ $footerBg }};">
    <div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div class="grid md:grid-cols-3 gap-12 mb-14">
            ...
            {{-- Navigation --}}
            <div>
                <h4 class="text-xs font-semibold uppercase tracking-[0.35em] mb-6" style="color: rgba(255,255,255,0.2); font-family: '{{ $bodyFont }}';">
                    {{ __('Menu') }}
                </h4>
                <ul class="space-y-3">
            ...
            <div>
                ...
                <div class="space-y-4">
                    @if($address)
                        <p class="text-sm font-light leading-relaxed" style="color: rgba(255,255,255,0.35); font-family: '{{ $bodyFont }}';">{{ $address }}</p>
                    @endif
                    @if($phone)
                        <a
                ...
                <div class="flex gap-3">
                    @if($facebookUrl)
                        <a
                            ...
                            style="border-color: rgba(255,255,255,0.12); color: rgba(255,255,255,0.4);"
        ...
        {{-- Copyright bar --}}
        <div class="pt-8 border-t flex flex-col sm:flex-row items-center justify-between gap-4" style="border-color: rgba(255,255,255,0.05);">
            <p class="text-xs font-light" style="color: rgba(255,255,255,0.18); font-family: '{{ $bodyFont }}';">
                {{ $copyright }}
            </p>
            <p class="text-xs font-light uppercase tracking-[0.3em]" style="color: rgba(255,255,255,0.18); font-family: '{{ $bodyFont }}';">
                Kapsalon Level
            </p>
        </div>
    </div>
