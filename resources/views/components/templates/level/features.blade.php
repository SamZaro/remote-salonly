{{--
    Level Template: Features Section
    Light section — clean bordered cards, orange icon dot, no dark bg
...
<section id="features" class="py-20 lg:py-28" style="background-color: {{ $secondaryColor }};">
    <div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        >
            ...
            <p class="text-base max-w-xs font-light" style="color: rgba(255,255,255,0.55); font-family: '{{ $bodyFont }}';">
                {{ $subtitle }}
            </p>
        </div>

        {{-- Features grid — transparent cards with border, orange accent --}}
        <div class="grid gap-0 border sm:grid-cols-2 lg:grid-cols-4" style="border-color: rgba(255,255,255,0.1);">
            @foreach($items as $item)
                ...
                >
                    ...
                    {{-- Description --}}
                    <p class="text-sm leading-relaxed font-light mt-auto" style="color: rgba(255,255,255,0.5); font-family: '{{ $bodyFont }}';">
                        {{ $item['description'] }}
                    </p>
