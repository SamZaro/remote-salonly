{{--
    Template-specifieke services voor Essence (Soft Luxury Salon)
...
@php
    ...
    $icons = [
        ...
        'extensions' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/>',
        'styling' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>',
    ];
@endphp

<section id="services" class="py-24 lg:py-32" style="background-color: {{ $accentColor }}40;">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
            <div class="flex items-center justify-center gap-4 mb-8">
                ...
                <span class="text-xs font-medium uppercase tracking-[0.3em]" style="color: {{ $secondaryColor }};">Services</span>
                <div class="w-12 h-px" style="background-color: {{ $secondaryColor }}40;"></div>
            </div>
            <h2
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            @foreach($items as $index => $item)
                ...
                >
                    ...
                    {{-- Description --}}
                    <p class="text-sm mb-6 leading-relaxed" style="color: {{ $textColor }}; opacity: 0.7;">
                        {{ $item['description'] }}
                    </p>

                    {{-- Price & CTA --}}
                    <div class="flex items-center justify-between pt-6 border-t" style="border-color: {{ $primaryColor }}60;">
                        <span class="text-sm font-medium" style="color: {{ $secondaryColor }};">
                            {{ $item['price'] }}
                        </span>
                        <a
                            href="#contact"
