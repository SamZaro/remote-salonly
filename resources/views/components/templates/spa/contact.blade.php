    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-6 lg:grid-cols-3 mb-10">
            ...
            <div
                ...
                x-data x-intersect.once="$el.style.opacity = 1; $el.style.transform = 'translateY(0)'"
                x-bind:style="'opacity: 0; transform: translateY(20px); transition: all 0.6s ease-out;'"
            >
                <div class="w-12 h-12 rounded-full flex items-center justify-center mb-5" style="background-color: {{ $primaryColor }};">
                ...
                <h3 class="text-sm font-bold uppercase tracking-wider mb-4" style="color: {{ $headingColor }}; font-family: '{{ $bodyFont }}', sans-serif;">{{ __('Address') }}</h3>
            ...
            <div
                ...
                x-data x-intersect.once="$el.style.opacity = 1; $el.style.transform = 'translateY(0)'"
                x-bind:style="'opacity: 0; transform: translateY(20px); transition: all 0.6s ease-out 0.1s;'"
            >
                <div class="w-12 h-12 rounded-full flex items-center justify-center mb-5" style="background-color: {{ $primaryColor }}30;">
                    <svg class="w-5 h-5" style="color: {{ $primaryColor }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                    </svg>
                </div>
                <h3 class="text-sm font-bold uppercase tracking-wider mb-4" style="color: {{ $primaryColor }}; font-family: '{{ $bodyFont }}', sans-serif;">{{ __('Call us') }}</h3>
                <a
            ...
            <div
                ...
                style="background-color: #ffffff;"
                x-data x-intersect.once="$el.style.opacity = 1; $el.style.transform = 'translateY(0)'"
                x-bind:style="'opacity: 0; transform: translateY(20px); transition: all 0.6s ease-out 0.2s;'"
            >
                <div class="w-12 h-12 rounded-full flex items-center justify-center mb-5" style="background-color: {{ $primaryColor }};">
                    <svg class="w-5 h-5" style="color: {{ $secondaryColor }};" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 class="text-sm font-bold uppercase tracking-wider mb-4" style="color: {{ $headingColor }}; font-family: '{{ $bodyFont }}', sans-serif;">{{ __('Opening Hours') }}</h3>
                <div class="space-y-2">
        ...
        >
            @if($mapEmbed)
                <div class="overflow-hidden min-h-[320px] rounded-lg">
                    <div class="h-full w-full">{!! $mapEmbed !!}</div>
                </div>
            @else
                <div
                    class="w-full min-h-[320px] flex items-center justify-center rounded-lg"
