            ...
            @foreach($categories as $index => $category)
                ...
                >
                    ...
                    <h3
                        ...
                        style="color: {{ $headingColor }}; font-family: '{{ $headingFont }}', serif; border-bottom: 2px solid {{ $primaryColor }};"
                    >
                        {{ $category['name'] }}
                    </h3>
                            ...
                            <div class="flex items-start justify-between gap-4 py-4" style="border-bottom: 1px solid {{ $accentColor }};">
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2">
                                        <h4 class="font-bold" style="color: {{ $headingColor }}; font-family: '{{ $headingFont }}', serif;">
                                            {{ $item['service'] }}
                                        </h4>
                                    ...
                                    <p class="text-sm mt-0.5" style="color: {{ $textColor }}; font-family: '{{ $bodyFont }}', sans-serif;">
                                        {{ $item['description'] }}
                                    </p>
                                </div>
                                <span class="text-xl font-bold shrink-0" style="color: {{ $secondaryColor }}; font-family: '{{ $headingFont }}', serif;">
                                    {{ $item['price'] }}
                                </span>
                            </div>
                        @endforeach
