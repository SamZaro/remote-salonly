{{--
    Template-specifieke hero voor Coupe (Kapsalon)
...
>
    ...
    <div class="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        <h1
            ...
            style="color: {{ $textColor }}; font-family: var(--font-family-heading);"
        >
            {!! $title !!}
        </h1>
        ...
        <p
            ...
            style="color: {{ $primaryColor }}; font-family: var(--font-family-heading);"
        >
            {{ $subtitle }}
        </p>
