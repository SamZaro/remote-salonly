...
>
    ...
    <div class="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        @if($title)<h1 class="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-6" style="color: {{ $textColor }}; font-family: var(--font-family-heading);">{!! $title !!}</h1>@endif
        @if($subtitle)<p class="text-5xl sm:text-6xl md:text-7xl mb-12 max-w-4xl mx-auto font-extrabold" style="color: {{ $primaryColor }}; font-family: var(--font-family-heading);">{{ $subtitle }}</p>@endif
