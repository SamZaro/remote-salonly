{{--
    Nova Template: Footer Section
    Trendy & Modern — bold dark footer with purple accents, Outfit headings, Inter body
...
<footer id="footer" class="relative pt-20 pb-12" style="background-color: {{ $secondaryColor }}; font-family: '{{ $bodyFont }}', sans-serif;">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            {{-- Decorative line with scissors icon --}}
                    ...
                    <div class="flex items-center gap-3 mb-8 justify-center md:justify-start">
                        @if($facebookUrl)
                            <a
                                ...
                                class="w-10 h-10 flex items-center justify-center rounded-sm transition-all duration-200 hover:scale-105"
