...
@php
    ...
    $subtitle = $content['subtitle'] ?? __('Walk-ins welcome, appointment recommended');
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            >
                ...
                <p class="text-sm mt-4 opacity-70" style="color: {{ $secondaryColor }};">
                    {{ __('Want to make an appointment? Call us!') }}
                </p>
            </div>
        ...
        <div class="mt-12 text-center">
            <p class="text-sm opacity-60" style="color: {{ $textColor }};">
                {{ __('Free parking available in the area. Wheelchair accessible.') }}
            </p>
        </div>
    </div>
</section>
