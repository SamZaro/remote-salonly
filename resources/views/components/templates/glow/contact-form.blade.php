{{--
    Glow Template: Contact Form Section
    Warm minimalist — clean two-column with image/color left, form right
...
<section id="contact-form" class="py-20 lg:py-28" style="background-color: {{ $backgroundColor }}; font-family: '{{ $bodyFont }}', sans-serif;">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-0 overflow-hidden" style="border-radius: 12px;">
            ...
            >
                ...
                <div class="relative z-10 p-8 lg:p-12 w-full">
                    @if($ctaLabel)
                        <span
                            class="block text-xs font-semibold uppercase tracking-[0.2em] mb-3 transition-all duration-700 delay-100"
                    ...
                    <h3
                        ...
                        style="color: #ffffff; font-family: '{{ $headingFont }}', sans-serif; font-weight: 700;"
                    >
