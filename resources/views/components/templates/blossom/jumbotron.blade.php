...
@php
    $title = $content['title'] ?? __('Pampering starts here');
    $subtitle = $content['subtitle'] ?? __('Book your treatment and discover pure relaxation');
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex items-center justify-center gap-8 mt-12 text-white/70 text-sm">
            <div class="flex items-center gap-2">
                ...
                <span>{{ __('Experienced stylists') }}</span>
            </div>
            <div class="flex items-center gap-2">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <span>{{ __('Premium products') }}</span>
            </div>
        </div>
    </div>
</section>
