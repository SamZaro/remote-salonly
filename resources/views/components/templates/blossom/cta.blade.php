...
@php
    ...
    $title = $content['title'] ?? __('Ready to shine?');
    $subtitle = $content['subtitle'] ?? __('Book your appointment today and let our team of experts pamper you');
    ...
    <div class="relative z-10 mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-wrap items-center justify-center gap-6 mt-14 pt-10 border-t border-white/20">
            <div class="flex items-center gap-2 text-white/80">
                ...
                <span class="text-sm">{{ __('Free consultation') }}</span>
            </div>
            <div class="flex items-center gap-2 text-white/80">
                <div class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="text-sm">{{ __('Premium products') }}</span>
            </div>
            <div class="flex items-center gap-2 text-white/80">
                <div class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span class="text-sm">{{ __('Relaxed atmosphere') }}</span>
            </div>
        </div>
    </div>
</section>
