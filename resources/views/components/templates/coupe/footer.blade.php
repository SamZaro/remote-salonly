...
@php
    ...
    $textColor = '#ffffff';  // Footer altijd wit op donkere achtergrond
    $headingColor = $theme['heading_color'] ?? '#0F0F0F';     // Headings (niet gebruikt in footer)
    $backgroundColor = $theme['footer_background'] ?? $secondaryColor;
@endphp

<footer id="footer" class="py-20 relative" style="background-color: {{ $backgroundColor }};">
    {{-- Decorative top border --}}
    <div class="absolute top-0 left-0 right-0 h-1" style="background: linear-gradient(to right, transparent, {{ $primaryColor }}, transparent);"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col items-center mb-16">
            ...
            <h3
                class="text-3xl font-light tracking-wide mb-4"
            ...
            @if($description)
                <p class="text-center max-w-lg opacity-70" style="color: {{ $textColor }};">
                    {{ $description }}
                </p>
            @endif
        </div>
        ...
        <div class="grid md:grid-cols-4 gap-8 mb-16">
            {{-- Navigation --}}
            <div>
                <h4 class="text-sm font-semibold uppercase tracking-wider mb-6" style="color: {{ $primaryColor }};">
                    {{ __('Menu') }}
                </h4>
                <ul class="space-y-3">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    @if($address)
                        <li class="text-sm opacity-70" style="color: {{ $textColor }};">
                            {{ $address }}
                        </li>
                    @endif
                    @if($phone)
            ...
            <div>
                ...
                <p class="text-sm opacity-70 mb-4" style="color: {{ $textColor }};">
        ...
        {{-- Bottom Bar --}}
        <div class="pt-8 border-t text-center" style="border-color: {{ $primaryColor }}30;">
