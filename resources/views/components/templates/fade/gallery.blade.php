{{--
    Fade Template: Gallery Section
    Dark section — horizontal carousel with gold accents + lightbox
                    ...
                    @if($images->count() > 3)
                        <div class="flex gap-2 shrink-0">
                            <button
                                ...
                                style="border-color: rgba(200,184,138,0.3); color: {{ $primaryColor }};"
                                onmouseover="this.style.borderColor='{{ $primaryColor }}'; this.style.backgroundColor='{{ $primaryColor }}'; this.style.color='{{ $secondaryColor }}'"
                                onmouseout="this.style.borderColor='rgba(200,184,138,0.3)'; this.style.backgroundColor='transparent'; this.style.color='{{ $primaryColor }}'"
            ...
            <template x-teleport="body">
                ...
                >
                    ...
                    <button
                        ...
                        onmouseout="this.style.borderColor='rgba(200,184,138,0.3)'"
    ...
    @else
        <div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
            <div class="flex items-center gap-3 mb-6">
                ...
                <span class="text-xs font-semibold uppercase tracking-[0.35em]" style="color: {{ $primaryColor }}; font-family: '{{ $bodyFont }}';">{{ __('Gallery') }}</span>
            </div>
            <h2 class="font-bold uppercase leading-[0.85] mb-10" style="font-family: '{{ $headingFont }}'; font-size: clamp(2.4rem, 4.5vw, 4rem); letter-spacing: -0.02em; color: #ffffff;">
                {{ $title }}
            </h2>
            <div class="flex gap-3 overflow-hidden">
                @for($i = 0; $i < 4; $i++)
                    <div class="shrink-0 w-[280px] sm:w-[340px] h-[280px] border flex items-center justify-center" style="border-color: rgba(200,184,138,0.15); background-color: rgba(255,255,255,0.03);">
                        <svg class="w-10 h-10" style="color: rgba(200,184,138,0.15);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
