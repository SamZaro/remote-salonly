{{--
    Blush Template: Footer Section
    Elegant nail studio — refined dark footer with gold accents
...
<footer id="footer" class="relative pt-20 pb-12" style="background-color: {{ $secondaryColor }}; font-family: {{ $bodyFont }};">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            <div class="flex items-center justify-center gap-4 mb-8">
                <div class="h-px w-16" style="background: linear-gradient(to right, transparent, {{ $primaryColor }});"></div>
                ...
                <div class="h-px w-16" style="background: linear-gradient(to left, transparent, {{ $primaryColor }});"></div>
            </div>
            ...
            @else
                <h3
                    class="text-3xl sm:text-4xl font-light tracking-tight mb-3"
        ...
        <div class="grid md:grid-cols-3 gap-12 lg:gap-16 mb-16">
            ...
            <div class="text-center md:text-left">
                <h4
                    class="text-xs font-medium uppercase tracking-[0.25em] mb-6"
            ...
            <div class="text-center md:text-left">
                    ...
                    <div class="flex items-center gap-3 mb-8 justify-center md:justify-start">
                        @if($facebookUrl)
                            <a
                                ...
                                class="w-10 h-10 flex items-center justify-center transition-all duration-300 hover:scale-105"
                ...
                <a
                    href="#contact"
                    class="inline-flex items-center justify-center px-8 py-3 text-xs font-medium uppercase tracking-[0.2em] transition-all duration-500 hover:scale-105"
                    style="background-color: {{ $primaryColor }}; color: {{ $secondaryColor }};"
                >
                    {{ __('Book a treatment') }}
        ...
        <div
            ...
            style="border-top: 1px solid {{ $primaryColor }}10;"
        >
            <p class="text-xs" style="color: rgba(255,255,255,0.20);">
                {{ $copyright }}
            </p>
        </div>
    </div>
