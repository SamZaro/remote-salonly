            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3 lg:gap-4">
                @for($i = 0; $i < 9; $i++)
                    <div
                        ...
                        style="background-color: {{ $primaryColor }}04; border: 1px dashed {{ $primaryColor }}12;"
                    >
                        <svg class="w-10 h-10" style="color: {{ $primaryColor }}15;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
